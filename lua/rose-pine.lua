...
local function set_highlights()
    ...
    local highlights = {}
    local legacy_highlights = { ---@type table<string, vim.api.keyset.highlight>
    ...
    local default_highlights = {
        ...
        Conditional = { fg = palette.pine, bold = true },
        ...
        Include = { fg = palette.foam, bold = styles.bold },
        ...
        Repeat = { fg = palette.pine, bold = true },
        Special = { fg = palette.foam },
        SpecialChar = { link = "Special" },
        SpecialComment = { fg = palette.iris },
        Statement = { fg = palette.inv, bold = styles.bold },
